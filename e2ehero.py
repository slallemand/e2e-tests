...
if __name__ == "__main__":
    ...
    parser.add_argument("--server", type=str, default="http://hero.my-app.svc.cluster.local:8080", help="Server URL (default: http://hero.my-app.svc.cluster.local:8080)")
    args = parser.parse_args()

    # List of endpoints to check
    endpoints = ["/q/health" , "/api/heroes/hello" , "/api/heroes/random"  ]
